...
<html>
<head>
<title>Entitiy Cv Projesi ~ Emirhan EREN</title>
<!-- custom-theme -->
...
<body>
	<div class="main">	
		<h1>Curriculum Vitae</h1> <!-- Cv Kelimesinin açılımı -->
		<div class="w3_agile_main_grids">
			<div class="w3layouts_main_grid_left">	
				<div class="w3_main_grid_left_grid">	
					<!-- Veri Çekme işlemi repeaterlar sayesinde gerçekleşir -->
					<asp:Repeater ID="Repeater1" runat="server">
						<ItemTemplate>
							<h2><%# Eval("Bilgiler") %></h2> <!-- Fotoğraf Üstü Başlık -->
						</ItemTemplate>
					</asp:Repeater>
					<p>Yazılım Mühendisi</p> <!-- Başlık altı açıklama -->
							...
							<div class="agileits_main_grid_right_grid">	
								...
								<p>
									<asp:Repeater ID="Repeater2" runat="server">
										<ItemTemplate>
											<!--Gelecek sütunun adı yazılır-->
											<%# Eval("Egitim") %>
										</ItemTemplate>
									</asp:Repeater>
								</p> 

								<div style="font-size:large; font-weight: bolder; margin-top:10px">
								<h3>İş Deneyimleri </h3> <!-- Deneyimler -->
								</div>
								<p>
